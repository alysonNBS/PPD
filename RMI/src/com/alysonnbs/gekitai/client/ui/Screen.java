...
public class Screen extends Thread implements MouseListener, ActionListener {
    ...
    public Screen(GameState state, int player) {
        super();
        this.state = state;
        this.player = player;
	...
	public void actionPerformed(ActionEvent e) {
        try {
            if (e.getSource() == submitTextButton || e.getSource() == textField) {
                state.sendMessage(new ChatMessage(player, textField.getText()));
                textField.setText("");
            }
